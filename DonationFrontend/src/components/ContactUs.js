    ...
    <NavigationBar />
      <Container className="bg-light text-center mt-2 p-2 pb-1 rounded">
        <h1 className="display-4 text-primary mb-4 font-weight-bold">
          CharityChime: NGO Donation Philanthro-Portal
        </h1>
        <p className="lead">
          ...
          <Col md={8}>
            <div className="bg-lighter mt-0 p-0 rounded">
              ...
              <p className="text-center font-weight-bold mb-4 lead">
                ...
                processes.
                <span className="text-primary">CharityChime</span> aims to
              ...
              <p className="text-center lead">
                ...
                with
                <span className="text-primary">CharityChime</span>, please
                  ...
                  <div className="card shadow">
                    <div className="card-body">
                      ...
                      <p className="mb-0">
                        ...
                        Address: XYZ street, Pune, India
                      </p>
                      <p className="mb-0">
                        <i className="fas fa-envelope mr-2"></i>
                        Email: CharityChime2024@gmail.com
                      </p>
                      <p className="mb-0">
                  ...
                  <div className="card shadow">
                    <div className="card-body">
                      <p className="text-primary font-weight-bold mb-4">
                        ...
                        Email:{" "}
                        <a
                          href="mailto:CharityChime2024@gmail.com"
                          style={{ color: "black" }}
                        >
                          CharityChime2024@gmail.com
                        </a>
                      </p>
                      <p>Phone: +91-7992217849</p>
                    </div>
                  </div>
                </div>
              </div>
