  ...
  return (
    <>
      ...
      <Container className="bg-light text-center mt-0 p-3 rounded">
        <h1 className="display-4 text-dark mb-4 font-weight-bold">
        ...
        <Container className="mt-4">
          <Row>
            <Col lg={4}>
              <Card className="border-0 shadow-lg rounded-lg " style={{ height: 755 }} >
                <div style={{ backgroundColor: '#8374c2' }}  className="p-3 text-black">
          ...
          <Container>
            <Link
              to="/login"
              className="btn btn-success rounded-pill bg-gradient my-4"
            >
              Donate Now
            </Link>
          </Container>
